...
import Stock_price_prediction as st
...
st.markdown("<h1 style='text-align: center; color: #0072B2;'>💹 Bảng điều khiển Dự báo Giá cổ phiếu</h1>", unsafe_allow_html=True)
st.markdown("---")

col1, col2 = st.columns([1, 2])
with col1:
    st.header("⚙️ Nhập mã cổ phiếu")
    ticker_input = st.text_input("Nhập mã chứng khoán (VD: AAPL, NVDA, FPT.VN...):", "AAPL").upper()
