...
footer_html = """
<style>
/* Make space for the footer and remove scrollbar */
.main .block-container {
    padding-bottom: 0rem; /* Adjust to match footer height */
}
.footer {
    position: fixed;
    left: 0;
    ...
    color: #888; /* Lighter grey for visibility */
    text-align: center;
...
<div class="footer">
    <p>© 2026 Nguyễn Vĩnh Phúc. Bảo lưu mọi quyền. Email: ngviphuc@gmail.com. SĐT: 0937 382 399</p>
</div>
"""
...
st.markdown("""<style>
    ...
    /* Target the specific h1, p, and hr elements */
...
st.markdown("<p style='text-align: right; font-style: italic;'>Học viên: LÊ HỒNG PHONG - Mã số: 8480201</p>", unsafe_allow_html=True)
st.markdown("---")
...
components.html(footer_html, height=30)
